            ...
            <div class="col-xl-12 col-lg-12 col-sm-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('laporanpenjualan.show') }}" method="get">
                            @csrf
                            ...
                            <div class="mb-3"><label for="jenis">Jenis Laporan</label>
                            <select class="form-control form-control-solid" name="jenis" id="jenis">
                                <option value="k">--Penjualan Kredit--</option>
                                <option value="t">--Penjualan Tunai--</option>
