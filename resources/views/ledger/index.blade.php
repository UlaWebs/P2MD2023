                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('ledger.show') }}" method="get">
                            ...
                            <div class="mb-3"><label for="tgl1">Dari Tanggal</label>
                                <input class="form-control form-control-solid" id="tgl1" name="tgl1" type="date"
                                    value="{{ old('tgl1') }}">
                            </div>
                            <div class="mb-3"><label for="tgl2">Sampai Tanggal</label>
                                <input class="form-control form-control-solid" id="tgl2" name="tgl2" type="date"
                                    value="{{ old('tgl2') }}">
                            </div>
                            <div class="mb-3"><label for="id_akun">Akun</label>
                                <select class="form-control form-control-solid" id="id_akun" name="id_akun">
