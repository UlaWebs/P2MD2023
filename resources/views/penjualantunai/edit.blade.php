        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h4 class="m-0 font-weight-bold text-primary">Edit Data Penjualan Tunai</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('penjualantunai.update') }}" method="post">
                        @csrf
                        <div class="mb-3"><label for="tgl_penjualan">Tanggal Penjualan Tunai</label>
                        <input type="hidden" id="id_penjualan_tunai_header" value="{{ $id_penjualan_tunai_header }}" name="id_penjualan_tunai_header">

                            <input class="form-control form-control-solid" id="tgl_penjualan" name="tgl_penjualan" type="date" value="{{ $tgl_penjualan }}">
                        </div>
                        ...
                        <div class="mb-3"><label for="id_pelanggan">Nama Pelanggan</label>
                            <select class="form-control form-control-solid" name="id_pelanggan" id="id_pelanggan">
                                ...
                                <option value="{{ $p->id_pelanggan }}" {{$p->id_pelanggan == $id_pelanggan  ? 'selected' : ''}}>{{ $p->nama_pelanggan }}</option>
                                @endforeach
                            </select>
                        </div>
