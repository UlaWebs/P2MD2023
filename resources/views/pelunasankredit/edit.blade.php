            ...
            <div class="col-xl-12 col-lg-12 col-sm-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h4 class="m-0 font-weight-bold text-primary">Ubah Data Pelunasan Kredit</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pelunasankredit.update') }}" method="post">
                            @csrf
                            <input type="hidden" id="id_pelunasan_kredit" name="id_pelunasan_kredit" value="{{ $id_pelunasan_kredit }}">
                            ...
                            <div class="mb-3"><label for="id_pengiriman_header">Pengiriman</label>
                                <select class="form-control form-control-solid" name="id_pengiriman_header"
                                    ...
                                    @foreach ($pengiriman as $p)
                                        <option value="{{ $p->id_pengiriman_header }}"
                                            {{ $p->id_pengiriman_header == $id_pengiriman_header ? 'selected' : '' }}>
                                            {{ $p->no_pengiriman }} -
